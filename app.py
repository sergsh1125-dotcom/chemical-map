...
**Можливості програми:** - Додавати точки вручну або завантажувати файл CSV  
...
2. Додайте точку вручну (широта, довгота, концентрація, час) або завантажте CSV із колонками: `lat`, `lon`, `value`, `time`(приклад: у колонках: lat: 50.00000; lon:30.00000; value: 0,01;time:2026-01-15 17:00).  
